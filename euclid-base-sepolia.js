...
const processSwap = async (privateKey, swapType, numTransactions, minEthAmount, maxEthAmount, minDelay, maxDelay, requireConfirmation, logger) => {
  ...
  const possibleTargetTokens = [ 'mon', 'usdc', 'usdt'];
  ...
  for (let i = 0; i < numTransactions; i++) {
    ...
    while (attempt < maxAttempts) {
      ...
      try {
        ...
        // Get swapResponse and txData here
        ...
        const tx = {
          to: config.contract, // Use the correct contract address field
          value: amountInWei,
          data: txData,
          gasLimit,
        ...
        try {
          ...
          // ethers v6: baseFeePerGas is BigInt, v5: BN
